...
class ElectricityChecker:
    power_messages = {
        True: "тестове повідомлення",
        False: "тестове повідомлення",
    }
    ...
    def check_and_send(self):
        ...
        if True:
            ...
            self.tg_bot.send_message(chat_id=self.chat_id, message_thread_id=thread_id if thread_id;, text=message)
